...
import { updatePassword } from "../../../../services/Operations/profileOperation";
...
function PasswordChange(){
    ...
    async function submitHandler(data){
        ...
        await updatePassword(token,data.oldPassword,data.newPassword);
    }
                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className=" flex flex-row-reverse gap-5">
                                ...
                                <button 
                                type="submit"
                                className={`cursor-pointer rounded-md bg-yellow-50 py-2 px-5 font-semibold text-richblack-900 ${loading?'pointer-events-none':'pointer-events-auto'}`}
                                >
                                    Save
                                </button>
